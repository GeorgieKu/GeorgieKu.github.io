...
// Получаем ссылку на ряд, в котором будут добавляться новые карточки
var cardRow = document.getElementById("row");

// Обработчик события клика на кнопку "Показать еще"

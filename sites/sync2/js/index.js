...
const swiper = new Swiper('.hero__swiper', {
  ...
  const swiper3 = new Swiper('.advertising__swiper', {
    ...
    inputField.addEventListener('input', function() {
      ...
      var inputField1 = document.querySelector('.modal__input');
      var modalBtn1 = document.querySelector('.modal__btn');
    
      inputField1.addEventListener('input', function() {
        if (inputField1.value.trim().length > 0) {
          modalBtn1.removeAttribute('disabled');
          ...
          modalBtn1.setAttribute('disabled', 'disabled');
        }
      });

(() => {
  ...
  class e {
    ...
    open(e) {
      if (
        ...
        // let e = document.getElementById("popupPlayer");
        let e1 = document.querySelector(".popup_show")
        let e = e1.querySelector(".video")
        e && e.play(), this.popupLogging("Открыл попап");
      } else
        this.popupLogging(
    ...
    close(e) {
      ...
      // let i = document.getElementById("popupPlayer");
      let i1 = document.querySelectorAll(".video")
    ...
    s({
      ...
      i("click", (e, s) => {
        const { $nextEl: i, $prevEl: a } = t.navigation,
          r = s.target;
        if (t.params.navigation.hideOnClick && !w(r).is(a) && !w(r).is(i)) {
          if (
            t.pagination &&
            t.params.pagination &&
  ...
  function le(e) {
    ...
    function c() {
      ...
      if (
        ("fraction" === s.type &&
          (a.find(re(s.currentClass)).text(s.formatFractionCurrent(c + 1)),
          a.find(re(s.totalClass)).text(s.formatFractionTotal(p))),
        "progressbar" === s.type)
      ) {
        let e;
  ...
  function oe(e) {
    ...
    function o() {
      ...
      if (
        ...
        e.children(`.${s.slideVisibleClass}`).each((e) => {
          l(a ? w(e).attr("data-swiper-slide-index") : w(e).index());
        });
    ...
    function d() {
      ...
      u ? (o(), s.off("scroll", d, f)) : a || ((a = !0), s.on("scroll", d, f));
    }
    i("beforeInit", () => {
  ...
  let de;
  const ce = (e) => {
      de && (de.pause(), (de.currentTime = 0));
      let t = e.querySelector("video");
      t && ((de = t), t.play(), (t.onclick = () => pe(t)));
    },
    pe = (e) => {
    ...
    ue = (e) => {
      let t = document
        .querySelector(".stories__pagg")
        .querySelectorAll(".swiper-pagination-bullet");
      for (let s = 0; s < e; s++)
        t[s].classList.add("swiper-pagination-bullet-active");
    };
  !(function () {
    ...
    document.querySelector(".swiper") &&
      new ie(".stories__slider-wrap", {
        ...
        preloadImages: !1,
        lazy: !0,
        pagination: { el: ".stories__pagg", clickable: !0 },
        navigation: { nextEl: ".stories-next", prevEl: ".stories-prev" },
        on: {
          slideChange: (e) => {
            ue(e.activeIndex), ce(e.slides[e.activeIndex]);
          },
        },
      }),
    ((t = !1, s = !0) => {
      new e({ logging: t, init: s });
    })(!1);
})();
